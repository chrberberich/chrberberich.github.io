...
$$
Y_{ij} = \beta_0 + \beta_1 X_{ij} + \alpha_{j} + \varepsilon_{ij},
$$


Here, $Y_{ij}$ is total unemployment for observation $i$ in year $j$, $X_{ij}$ is total vacancies, $\beta_0$ and $\beta_1$ are fixed-effect parameters, $\alpha_{j}$ is a year-specific random intercept, and $\varepsilon_{ij}$ is the idiosyncratic error.
...
<table style="text-align:center; width:100%; border-collapse:collapse;">
  ...
  <tr><td></td><td><em>Dependent variable:</em></td></tr>
  <tr><td></td><td style="border-bottom: 1px solid black">total_unemp</td></tr>
  ...
  <!-- line under Fixed effects -->
  <tr><td colspan="2" style="border-bottom: 1px solid black"></td></tr>

  <!-- Coefficients -->
  <tr><td style="text-align:left">total_vac</td><td>-0.687</td></tr>
  <tr><td></td><td>[-0.913, -0.455]</td></tr>
  <tr><td style="height:6px;"></td><td></td></tr>

  <tr><td style="text-align:left">Constant</td><td>3308</td></tr>
  <tr><td></td><td>[3078, 3526]</td></tr>

  <tr><td colspan="2" style="border-bottom: 1px solid black"></td></tr>

  <!-- Random effects header -->
  <tr>
    <td colspan="2" style="text-align:left; font-weight:bold;">
      Random effects
    </td>
  </tr>
  <!-- line under Random effects -->
  <tr><td colspan="2" style="border-bottom: 1px solid black"></td></tr>

  <!-- Random effects column labels -->
  <tr>
    <td style="text-align:left; font-style:italic;">Groups</td>
    <td style="text-align:center; font-style:italic;">Std. Dev.</td>
  </tr>

  <!-- Random effects rows -->
  <tr>
    <td style="text-align:left;">year (Intercept)</td>
  ...
  <!-- Model statistics -->
  <tr>
    <td colspan="2" style="text-align:left; font-weight:bold; padding-top:6px;">
      Model statistics
    </td>
  </tr>
  <tr><td colspan="2" style="border-bottom: 1px solid black"></td></tr>
  ...
  <tr>
    ...
    <td style="text-align:right">
      Coefficients and 95% confidence intervals estimated using 2000 bootstrap resamples.
    </td>
  </tr>
