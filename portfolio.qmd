...
<div id="iframeContainer">
  <!-- Erstes iFrame -->
  <iframe id="iframe1" src="portfolio/world map GDP trans.svg" width="100%" height="820px" style="border:none;"></iframe>

  <!-- Zweites iFrame (standardmäßig versteckt) -->
  <iframe id="iframe2" src="portfolio/GDP_time trans.svg" width="100%" height="820px" style="border:none; display:none;"></iframe>
</div>
