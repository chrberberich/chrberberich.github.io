...
<iframe id="iframe1" src="portfolio/world map GDP trans.svg" width="100%" height="700px" style="border:none;">

</iframe>

<!-- Zweites iFrame (standardmäßig versteckt) -->

<iframe id="iframe2" src="portfolio/GDP_time trans.svg" width="100%" height="700px" style="border:none; display:none;">
...
<iframe src="portfolio/Micro_interactive.html" width="100%" height="1000px" style="border:none;">
...
<iframe src="portfolio/Macro_interactive.html" width="100%" height="1000px" style="border:none;">
