...
![](portfolio/world map GDP white.svg){#iframe1 width="80%" style="border:none;  display:block; margin: 0 auto;"}

<!-- Zweites Bild (standardmäßig versteckt) -->

![](portfolio/GDP_time white.svg){#iframe2 width="83%" style="border:none;  display:block; margin: 0 auto;"}
:::
